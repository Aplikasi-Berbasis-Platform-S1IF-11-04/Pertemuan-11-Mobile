        ...
        child: Column(children: [
          ...
          Card(
            ...
            child: Padding(padding: const EdgeInsets.all(20), child: Column(children: [
              ...
              const Text('Raka Andriy Shevchenko',
                  style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
              const Text('2311102054', style: TextStyle(color: Colors.grey)),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(padding: const EdgeInsets.all(20), children: [
        ...
        const Center(child: Text('Raka Andriy Shevchenko',
            style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold))),
        const Center(child: Text('2311102054', style: TextStyle(color: Colors.grey))),
        const SizedBox(height: 20),
        ...info.map((r) => Card(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(padding: const EdgeInsets.all(20), children: [
        ...
        const SizedBox(height: 12),
        ...[
          [Icons.person,    'Developer', 'Raka Andriy Shevchenko'],
          [Icons.badge,     'NIM',       '2311102054'],
