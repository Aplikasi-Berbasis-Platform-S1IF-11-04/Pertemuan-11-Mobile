        ...
        child: Column(children: [
          ...
          Card(
            ...
            child: Padding(padding: const EdgeInsets.all(20), child: Column(children: [
              ...
              const Text('Alfin Ilham Berlianto',
                  style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
              const Text('2311102047', style: TextStyle(color: Colors.grey)),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(padding: const EdgeInsets.all(20), children: [
        ...
        const Center(child: Text('Alfin Ilham Berlianto',
            style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold))),
        const Center(child: Text('2311102047', style: TextStyle(color: Colors.grey))),
        const SizedBox(height: 20),
        ...info.map((r) => Card(
...
class HalamanTentang extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    WidgetsBinding.instance.addPostFrameCallback((_) => popupAlert(context,
      ...
      isi: 'Ini adalah aplikasi Flutter buatan Alfin Ilham Berlianto untuk tugas praktikum.',
    ...
    return Scaffold(
      ...
      body: ListView(padding: const EdgeInsets.all(20), children: [
        ...
        const SizedBox(height: 12),
        ...[
          [Icons.person,    'Developer', 'Alfin Ilham Berlianto'],
          [Icons.badge,     'NIM',       '2311102047'],
