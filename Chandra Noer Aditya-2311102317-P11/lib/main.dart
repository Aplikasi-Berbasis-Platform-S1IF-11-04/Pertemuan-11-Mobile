...
class _HomePageState extends State<HomePage> {
  ...
  final TextEditingController namaController =
      TextEditingController(text: 'Chandra Noer Aditya');
      ...
      drawer: Drawer(
        child: ListView(
          ...
          children: [
            ...
            drawerItem(Icons.crop_square, 'Belajar Container', 1, 'Belajar Container'),
            drawerItem(Icons.person, 'Biodata', 2, 'Biodata'),
            drawerItem(Icons.scoreboard, 'Poster dan Papan Skor', 3, 'Poster dan Papan Skor'),
    ...
    return Column(
      ...
      children: [
        const Padding(
          ...
          child: Text('Ini Aplikasi Saya', style: TextStyle(fontSize: 24, color: Colors.black87)),
        ),
        Container(
          ...
          child: const Text('Belajar Container', style: TextStyle(fontSize: 18, color: Colors.black)),
        ),
      ],
    );
  }
  ...
  Widget halamanBiodata() {
    return const Padding(
      ...
      child: Text(
        '2311102317 - Chandra Noer Aditya',
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('$jumlahMahasiswa', style: const TextStyle(fontSize: 72, fontWeight: FontWeight.bold, color: Colors.black87)),
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            const Align(
              alignment: Alignment.topLeft,
              child: Text('Login', style: TextStyle(fontSize: 26, color: Colors.black87)),
            ),
            const SizedBox(height: 24),
            const Text('FROM LOGIN', style: TextStyle(fontSize: 16, color: Colors.black87)),
            const SizedBox(height: 28),
            TextField(controller: usernameController, decoration: const InputDecoration(border: OutlineInputBorder(), hintText: 'Silahkan masukan username')),
            const SizedBox(height: 45),
            TextField(controller: passwordController, obscureText: true, decoration: const InputDecoration(border: OutlineInputBorder(), hintText: 'Silahkan masukan password')),
            const SizedBox(height: 28),
            ElevatedButton(
  ...
  Widget halamanInputData() {
    return Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('Ini Aplikasi Saya', style: TextStyle(fontSize: 24, color: Colors.black87)),
          const SizedBox(height: 20),
          TextField(
          ...
          const SizedBox(height: 20),
          ElevatedButton.icon(
            onPressed: () => tampilkanPesan('Nama yang diinput: ${namaController.text}'),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 20),
            const Text('Tugas Navigasi dan Notifikasi', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.black87)),
            const SizedBox(height: 12),
            const Text(
